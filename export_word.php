...
$filename = 'lesson_plan_' . $row['id'] . '_DepEd2026_A4.doc';
...
| This prevents Microsoft Word from stretching the table beyond A4 width.
|--------------------------------------------------------------------------
*/
...
<table class="no-border keep-together">
    ...
    <tr>
        ...
        <td class="center header-center">
            ...
            <div class="subtitle bold">Department of Education</div>
            <div class="subtitle">Region: ________________________________</div>
            <div class="subtitle">Schools Division Office: ________________________________</div>
            <div class="subtitle bold"><?php echo cell_out($row['school']); ?></div>
        </td>
...
<table>
    ...
    <tr>
        <td class="label">
            ...
            <span class="section-desc">Cite how AI was used in the formulation of the lesson plan.</span>
        </td>
...
<table>
    ...
    <tr>
        <td class="label">
            <i>Pre-Lesson:</i><br>
            <span class="section-desc">Describe how learners will get ready for the lesson.</span>
        </td>
